...
def resolucao(tela: Tela) -> Aspecto:
    ...
    de 4:3, 16:9 ou outro (projet: e um tipo enumerado para representar o aspecto).
...
def imagem(tela: Tela, imagem: Tela) -> bool:
    """
    Verifica se uma imagem pode ser apresentando em uma tela sem necessidade de rotação
    ou mudança temanha

    Exemplos
    >>> imagem(Tela(1080, 1920), Tela(600, 800))
    True
    >>> imagem(Tela(600, 800), Tela(1080, 1920))
    False
    """

    return tela.altura >= imagem.altura and tela.largura >= imagem.largura
